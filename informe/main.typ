...
8. _Bag_ (bolso), y
9. _Ankle boot_ (bota).
Algunos ejemplos de cada categoría se muestran en la @fig:examples.

#figure(
    placement: auto,
    image("img/examples.svg", width: 100%),
